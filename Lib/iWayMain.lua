...
Converted["_settingsFrame"].BackgroundColor3 =
    Color3.fromRGB(31.000095047056675, 31.000095047056675, 31.000095047056675)
...
Converted["_Desc"].Text =
    "Click the button above and press a key/mouse button. Then select what you want to bind it to."
...
local function RNOB_fake_script() -- Fake Script: StarterGui.InfiniteWay.IY_Handler
        ...
        coroutine.wrap(
            function()
                ...
                messageGui:TweenSizeAndPosition(
                    UDim2.new(0, 1000, 0, 24),
                    UDim2.new(0.5, -500, 0, 10),
                    "Out",
                    "Quart",
                    0.5
                )
        ...
        function(property)
            if property == "Text" and GUI.PopupFrame.Items.Search.TextBox:IsFocused() then
                ...
                if GUI.PopupFrame.Select.highlight.Position ~= UDim2.new(0, 4, 0, 4) then
                    GUI.PopupFrame.Items:TweenPosition(UDim2.new(0, -335, 0, 46), "InOut", "Quart", 0.5, true, nil)
                    GUI.PopupFrame.Select.highlight:TweenPosition(
                        UDim2.new(0, 4, 0, 4),
                        "InOut",
                        "Quart",
                        0.3,
    ...
    GUI.Parent.KeybindsEditor.keybindCmd.FocusLost:Connect(
        function()
    ...
    script.Parent.Cmdbar.FocusLost:Connect(
        function(enterpressed)
            if enterpressed then
